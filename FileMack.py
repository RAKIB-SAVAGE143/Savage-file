...
#------------------[ LOGO ]-----------------#
logo ='''
\x1b[1;96m.___._..   .___  .  ..__. __ .  .
\x1b[1;96m[__  | |   [__   |\/|[__]/  `|_/ 
\x1b[1;96m|   _|_|___[___  |  ||  |\__.|  \


=====================================   
     Name: PRINCE RAKIB
     GITHUB: SAVAGE-RAKIB143
     FB NAME: PRINCE RAKIB
=====================================     
'''                                 
#--------------------[ ENTRY ]--------------#    
...
def methode1_ua():
    ua="Dalvik/2.1.0 (Linux; U; Android 8.0.0; SM-G930F Build/R16NW) [FBAN/FB4A;FBAV/187.0.0.43.81;FBPN/com.facebook.katana;FBLC/fr_FR;FBBV/122388438;FBCR/Bouygues Telecom;FBMF/samsung;FBBD/samsung;FBDV/SM-G930F;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,h"
    return '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'0.0.'+ str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';'+ua
...
def dump_file():
    ...
    print(' \x1b[1;97m• \x1b[1;91m>>\x1b[1;97m ENTER FILE NAME WITHOUT "/SDCARD/"');linex()
